...
export default function Products() {
  ...
  const categoryFilterOptions: FilterOption[] = [
    ...
    { label: t("beers"), value: "cervezas" },
    { label: t("cocktails"), value: "cocteles" },
    { label: t("bottles"), value: "botellas" },
    { label: t("nonAlcoholic"), value: "sin_alcohol" },
    { label: t("snacks"), value: "snacks" },
    { label: t("services"), value: "servicios" },
  ];
                ...
                {(field) => (
                  <div className="flex flex-col sm:grid sm:grid-cols-4 sm:items-center gap-2 sm:gap-4">
                    ...
                    <Select value={field.state.value} onValueChange={(value) => field.handleChange(value)}>
                      ...
                      <SelectContent>
                        <SelectItem value="cervezas">{t("beers")}</SelectItem>
                        <SelectItem value="cocteles">{t("cocktails")}</SelectItem>
                        <SelectItem value="botellas">{t("bottles")}</SelectItem>
                        <SelectItem value="sin_alcohol">{t("nonAlcoholic")}</SelectItem>
